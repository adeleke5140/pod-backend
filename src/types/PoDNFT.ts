...
export interface PoDNFTInterface extends utils.Interface {
  contractName: "PoDNFT";
  functions: {
    "approve(address,uint256)": FunctionFragment;
    "approveProject(bytes32,address)": FunctionFragment;
    "approvedProjectOwners(bytes32)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "approvedProjectOwners",
    values: [BytesLike]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "projectTokenIdMap",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
...
export interface PoDNFT extends BaseContract {
  contractName: "PoDNFT";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PoDNFTInterface;
